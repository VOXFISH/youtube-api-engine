...
namespace Rice
{
    class RICE_API PerspectiveCamera : public Camera
    {
    private:
    ...
    public:
        PerspectiveCamera(float fovDegree, float aspectRatio, float nearClip, float farClip);

        void SetPerspective(float fovDegree, float aspectRatio, float nearClip, float farClip);
